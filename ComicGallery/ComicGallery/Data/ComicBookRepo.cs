        ...
        private static ComicBook[] _comicBooks = new ComicBook[]
         {
             ...
             new ComicBook()
            {
             ...
             new ComicBook()
             {
                 ...
                 "Thorn is discovered by Lord Tarsil and the corrupted Stickeaters and thrown into a dungeon with Fone Bone. " +
                 "As she sleeps, a message comes to her about the mysterious \"Crown of Horns\".</p>",
                 Artists = new Artists[]
                 {
